...
[![Channel](https://img.shields.io/badge/Follow-Telegram-blue?logo=telegram)](https://t.me/Aniruf_Monet)
...
此项目基于[MIUI Monet Icons v1.0.0](https://t.me/monetproject/142)<br/>
~~原计划基于[MIUI Monet Icons v2.0.0](https://t.me/monetproject/164)~~<br/>
~~但 Monet Icons 并不工作~~

## - 文件来源

- 此项目删除了[其](https://t.me/monetproject/142)中的***所有图标文件***<br/>
- 使用 [Lawnicons](https://github.com/LawnchairLauncher/lawnicons) 的图标替换<br/>
(一些可能会来自于应用本身)
...
- *可能仅适应 HyperOS 1.0<br/>
''Mi11 Ultra 1.0.2.0 RELEASE-4.39.15.8280-07041845(439158280) bypass''